...
function selectYellow(){
    ...
    if (document.getElementById('yellowOff')){
        ...
        content.innerHTML = '<a-image id="yellow" src="./static/images/2D assets from users/CyclingPath_4k.png" scale="10 10 10" gps-projected-entity-place="latitude: 1.401492; longitude: 103.749418" look-at="[gps-camera]" rotation="0 180 0"></a-image>';
}
...
function selectBlue(){
    ...
    if (document.getElementById('blueOff')){
        ...
        content.innerHTML = '<a-entity id="blue" gltf-model="./static/3D-file/Updated Assets from users/bicycleCrossing_textured.glb" scale="10 10 10" gps-projected-entity-place="latitude: 1.401492; longitude: 103.749418" rotation="0 90 0" animation-mixer look-at="[gps-camera]" rotation-reader></a-entity>';
}
